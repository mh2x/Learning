...
namespace ProductManagement.Services.Products
{
...

    {
        ...
        public async Task<PagedResultDto<ProductDto>>
        GetListAsync(
...

        {
            ...
            //WithDetailsAsync is same as .Include in EFCore
        ...
        public async Task UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            //EF Core does this automatically, 
            //but we can do it here to support other DBs like MongoDB

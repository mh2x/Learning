...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7b9649df-c067-4a34-826e-4cf6de232650
```

> `7b9649df-c067-4a34-826e-4cf6de232650` is the password of the certificate, you can change it to any password you want.
...
Details: https://docs.abp.io/en/abp/latest/Tutorials/Part-4?UI=BlazorServer&DB=EF

Each project is used to test the related project. Test projects use the following libraries for testing:

Xunit as the main test framework.   https://github.com/xunit/xunit 
Shoudly as the assertion library.   https://github.com/shouldly/shouldly
NSubstitute as the mocking library. http://nsubstitute.github.io/

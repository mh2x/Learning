...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f4db6269-855a-4a8e-9dd8-a81c3434d1dd
```

> `f4db6269-855a-4a8e-9dd8-a81c3434d1dd` is the password of the certificate, you can change it to any password you want.

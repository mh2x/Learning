...
using TodoApp.Blazor.Components;
...
public class TodoAppBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "12572267-a0bf-4614-928d-cbb908591fbf");
            });
        }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/TodoApp.Blazor.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options =>
        {
            ...
            options.AdditionalAssemblies.Add(typeof(TodoAppBlazorClientModule).Assembly);
        });
    }

...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 12572267-a0bf-4614-928d-cbb908591fbf
```

> `12572267-a0bf-4614-928d-cbb908591fbf` is the password of the certificate, you can change it to any password you want.

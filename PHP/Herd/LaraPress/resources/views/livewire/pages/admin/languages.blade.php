...
new class extends Component {
    ...
    public function mount()
    {
        ...
        $this->locales = $this->langManager->getLocalesArray();
        //dd('mounted');
    }
}; ?>
        ...
        <x-form wire:submit="save">
            ...
            <div class="lg:grid grid-cols-8">
                ...
                <div class="col-span-2 grid gap-3">
                    {{-- Multi selection --}}
                    <x-choices-offline label="App Locales" wire:model="app_locales" :options="$locales" searchable class="focus:text-red-500" />
                </div>

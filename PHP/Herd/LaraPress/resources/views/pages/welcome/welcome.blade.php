...
<x-main-layout>
    ...
    <p
        class="self-start inline font-sans text-xl font-medium text-transparent bg-clip-text bg-gradient-to-br from-purple-700 to-purple-300">
        made simple and fun!
    </p>
    ...
    <div class="grid gap-4 md:grid-cols-3">
        ...
        <div class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-b from-gray-800 to-black">
            <p
                class="flex items-center justify-center text-4xl font-semibold text-white bg-blue-800 rounded-full shadow-lg w-14 h-14">
                2
            </p>
            <div class="h-6"></div>
        ...
        <div class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-bl from-gray-800 to-black">
            <p
                class="flex items-center justify-center text-4xl font-semibold text-white bg-purple-800 rounded-full shadow-lg w-14 h-14">
                3
            </p>
            <div class="h-6"></div>

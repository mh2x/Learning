    ...
    @volt('update-profile')
        <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
            <div>
                ...
                <x-breeze.text-input wire:model="name" id="name" name="name" type="text" class="mt-1 block w-full"
            ...
            <div>
                ...
                <x-breeze.text-input wire:model="email" id="email" name="email" type="email"

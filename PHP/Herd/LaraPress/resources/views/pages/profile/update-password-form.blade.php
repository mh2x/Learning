...
<section>
    ...
    @volt('update-password')
        <form wire:submit="updatePassword" class="mt-6 space-y-6">
            <div>
                <x-breeze.input-label for="update_password_current_password" :value="__('Current Password')" />
                <x-breeze.text-input wire:model="current_password" id="update_password_current_password"
            ...
            <div>
                ...
                <x-breeze.text-input wire:model="password" id="update_password_password" name="password" type="password"
            ...
            <div>
                ...
                <x-breeze.text-input wire:model="password_confirmation" id="update_password_password_confirmation"
